...
wiki_urls <- wiki_data |>
  ...
  mutate(wikipedia_url =
           case_match(taxon.name,
                      ...
                      "Cryptoblepharus virgatus" ~ "https://en.wikipedia.org/wiki/Cryptoblepharus_virgatus",
                      "Eolophus roseicapilla albiceps" ~ "http://en.wikipedia.org/wiki/Galah",
                      "Eudynamys orientalis cyanocephalus" ~ "https://en.wikipedia.org/wiki/Pacific_koel",
                      "Gymnorhina tibicen tibicen" ~ "https://en.wikipedia.org/wiki/Australian_magpie",
                      "Intellagama lesueurii lesueurii" ~ "https://en.wikipedia.org/wiki/Australian_water_dragon",
                      "Malurus melanocephalus melanocephalus" ~ "http://en.wikipedia.org/wiki/Red-backed_fairywren",
                      "Ninox boobook boobook" ~ "https://en.wikipedia.org/wiki/Australian_boobook",
                      "Pardalotus punctatus punctatus" ~ "http://en.wikipedia.org/wiki/Spotted_pardalote",
                      "Podargus strigoides strigoides" ~ "http://en.wikipedia.org/wiki/Tawny_frogmouth",
                      "Porphyrio melanotus melanotus" ~ "http://en.wikipedia.org/wiki/Australasian_swamphen",
                      "Sphecotheres vieilloti vieilloti" ~ "http://en.wikipedia.org/wiki/Australasian_figbird",
                      "Tachyglossus aculeatus aculeatus" ~ "http://en.wikipedia.org/wiki/Short-beaked_echidna",
                      "Tropidonophis mairii mairii" ~ "https://en.wikipedia.org/wiki/Tropidonophis_mairii",
...
missing_species_urls <- readr::read_rds("./output_data/missing_species_urls.rds")
...
readr::write_rds(wiki_urls_list,
